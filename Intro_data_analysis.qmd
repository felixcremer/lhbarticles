...
```{julia}
@pyexec """ #| hide_line
cosmo_era6 = xr.open_mfdataset("data/*.nc", parallel=True, engine='h5netcdf')
""" #|hide_line
```
:::
...
#cosmo_era6 = cosmo_era6.rio.write_crs(crs)
#cosmo_era6 = cosmo_era6.rio.reproject("EPSG:4326")["tas"].chunk({"time":1})
""" #|hide_line
```
:::
...
cosmo_era6_summer = cosmo_era6.sel(time=is_summer(cosmo_era6['time.month']))
cosmo_era6_winter = cosmo_era6.sel(time=is_winter(cosmo_era6['time.month']))
""" #|hide_line
=#
```
::: 
...
#=
@pyexec """ #| hide_line
cosmo_era6_winter_mean = cosmo_era6_winter.mean(dim="time",skipna=True)
cosmo_era6_summer_mean = cosmo_era6_summer.mean(dim="time",skipna=True)

cosmo_era6_winter_std = cosmo_era6_winter.std(dim="time",skipna=True)
cosmo_era6_summer_std = cosmo_era6_summer.std(dim="time",skipna=True)
""" #|hide_line
=#
```
