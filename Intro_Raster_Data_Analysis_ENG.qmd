...
deu = GADM.get("DEU")
projdeu = GO.reproject(only(deu.geom), ProjString(AG.toPROJ4(AG.getspatialref(deu.geom[1]))), ProjString(proj))
...
In this tutorial we learned how to work with raster data in .
