...
```{julia}
@pyexec """ #| hide_line
global cosmo_rea6_summer, cosmo_rea6_winter
def is_summer(month):
...
```{julia}
@pyexec """ #| hide_line
       global cosmo_rea6_winter_mean, cosmo_rea6_winter_std,cosmo_rea6_summer_mean, cosmo_rea6_summer_std
